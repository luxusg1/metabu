...
def get_learned_metafeatures(datasets_has_priors_use_for_train, train_metafeatures, top_k_dataset, prior_preprocessor,
                             learning_rate, alpha, seed=1, ):
    ...
    cost_matrix = get_cost_matrix_distribution(datasets_has_priors_use_for_train=datasets_has_priors_use_for_train,
                                               top_k_dataset=top_k_dataset, prior_preprocessor=prior_preprocessor)
